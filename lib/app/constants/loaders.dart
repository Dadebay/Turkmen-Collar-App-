...
Widget loaderBanner() {
  return Container(margin: const EdgeInsets.all(8), height: 220, width: Get.size.width, decoration: const BoxDecoration(borderRadius: borderRadius15, color: kGreyColor), child: Center(child: spinKit()));
}
